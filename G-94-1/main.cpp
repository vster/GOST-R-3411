...
int main() 
{
	...
	// Заполнение буфера для хеширования
	for ( i = 0; i<128; i++ )
		buf[i] = 'U';
	buf[i] = 0x00;
 	len = strlen((char*)buf);
	...
	cout << "\nTEST 8\n\n";
	cout << "Text length  = 128 bytes \n\n";
	cout << "Text to hash = 128 x \"U\" " << endl << endl;    
	...
	cout << "\nTEST 9\n\n";
	cout << "Text length  = 1000000 bytes \n\n";
	cout << "Text to hash = 1000000 x \"a\" " << endl << endl;    
